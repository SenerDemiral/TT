...
namespace TTDB
{
   public class InitDB
   {
      public void Init()
      {
            ...
            TakimOyuncu takimOyuncu111 = new TakimOyuncu() { Turnuva = turnuva1, Takim = takim1, Oyuncu = oyuncu1 };
            TakimOyuncu takimOyuncu112 = new TakimOyuncu() { Turnuva = turnuva1, Takim = takim1, Oyuncu = oyuncu2 };
            TakimOyuncu takimOyuncu113 = new TakimOyuncu() { Turnuva = turnuva1, Takim = takim1, Oyuncu = oyuncu3 };
            TakimOyuncu takimOyuncu114 = new TakimOyuncu() { Turnuva = turnuva1, Takim = takim1, Oyuncu = oyuncu4 };

            TakimOyuncu takimOyuncu125 = new TakimOyuncu() { Turnuva = turnuva1, Takim = takim2, Oyuncu = oyuncu5 };
            TakimOyuncu takimOyuncu126 = new TakimOyuncu() { Turnuva = turnuva1, Takim = takim2, Oyuncu = oyuncu6 };
            TakimOyuncu takimOyuncu127 = new TakimOyuncu() { Turnuva = turnuva1, Takim = takim2, Oyuncu = oyuncu7 };

            TakimOyuncu takimOyuncu137 = new TakimOyuncu() { Turnuva = turnuva1, Takim = takim3, Oyuncu = oyuncu8 };
            TakimOyuncu takimOyuncu138 = new TakimOyuncu() { Turnuva = turnuva1, Takim = takim3, Oyuncu = oyuncu9 };

            TakimOyuncu takimOyuncu31 = new TakimOyuncu() { Turnuva = turnuva2, Takim = takim4, Oyuncu = oyuncu1 };
            TakimOyuncu takimOyuncu32 = new TakimOyuncu() { Turnuva = turnuva2, Takim = takim4, Oyuncu = oyuncu2 };

            TurnuvaMusabaka turnuvaMusabaka11 = new TurnuvaMusabaka() { Turnuva = turnuva1, HomeTakim = takim1, GuestTakim = takim2, Trh = DateTime.Now };
            ...
            TurnuvaMusabaka turnuvaMusabaka12 = new TurnuvaMusabaka() { Turnuva = turnuva1, HomeTakim = takim3, GuestTakim = takim1, Trh = DateTime.Now };
